  ...
  return (
    <div className="main-container mt-10">
      <div className=" w-11/12 md:w-10/12 2xl:w-8/12 mx-auto mt-10 mb-10">
        <div className="flex text-gray-700 dark:text-gray-200 rounded-md font-extrabold flex-col lg:flex-row justify-evenly  bg-white dark:bg-subMajorDark mx-auto p-5">
