...
const SuggestedForYou = () => {
  return (
    <div className="main-container mt-5">
      ...
      <div className="suggestedContainer min-w-[305px] w-11/12 sm:w-9/12 mx-auto h-fit mt-5d dark:bg-majorDark py-3 rounded-md flex overflow-x-scroll gap-4 mt-2">
