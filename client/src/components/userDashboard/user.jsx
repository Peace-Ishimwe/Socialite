      ...
      <div className="relative w-full h-fit dark:bg-subMajorDark bg-white rounded-t-3xl">
        <div className="relative">
          ...
          <div>
            ...
            <input type="file" name="cover" id="cover" className="hidden" ref={imageRefCover} onChange={onCoverImageChange} />
          </div>
        </div>
          ...
          {imageProfile && (
              <div className="previewImage w-full absolute bg-whiteflex items-center justify-center flex-col mt-16  bg-white dark:bg-subMajorDark py-5  shadow-xl flex">
                ...
                <img
                  ...
                  alt=""
                />
                <button type="submit" className="px-4 py-2 bg-blue-500 rounded-md text-gray-200 text-lg font-normal flex items-center gap-3 mt-5">Post <RocketIcon /> </button>
              </div>
            )}
